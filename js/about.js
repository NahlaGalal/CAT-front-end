...
playVideoElm.addEventListener("click", () =>
  videoPlayerElm.classList.remove("hidden")
);
videoPlayerCloseElm.addEventListener("click", () =>
  videoPlayerElm.classList.add("hidden")
);
